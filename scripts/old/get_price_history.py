...
n_stocks = 500
historical_sandp = pd.read_html("https://github.com/leosmigel/analyzingalpha/blob/master/sp500-historical-components-and-changes/sp500_history.csv")[0]
historical_sandp.date = pd.to_datetime(historical_sandp.date)
historical_sandp_2010 = historical_sandp.loc[(((historical_sandp.variable == "added_ticker") &
                                               (historical_sandp.date<"2010-01-01")) |
                                              ((historical_sandp.variable == "removed_ticker") &
                                               (historical_sandp.date>"2010-01-01")) ),'value']
...
stock_data_dict = yahoo_financials.get_historical_price_data(start_date=start_str, end_date=end_str,time_interval='daily')
