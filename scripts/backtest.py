...
strat_to_test = [strat.red_white_blue,
                 strat.buy_and_hold]

performance_outcome = [strat(data_df = data_df) for strat in strat_to_test]
metrics = [evaluate_strategies(data_df  = data_df,stock_tocker_str = stock_tocker_str,performance_outcome = pc) for pc in performance_outcome]